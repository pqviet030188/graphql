...
describe("Post N+1 test", () => {
  it("posts with authors does not cause N+1 queries", async () => {
  ...
  it("posts with authors with posts does not cause N+1 queries", async () => {
    const queries: string[] = [];
    const origLogging = (sequelize as any).options?.logging;
    // capture SQL statements executed by Sequelize during the request
    (sequelize as any).options = (sequelize as any).options || {};
  ...
  it("posts with medias does not cause N+1 queries", async () => {
    const queries: string[] = [];
    const origLogging = (sequelize as any).options?.logging;
    // capture SQL statements executed by Sequelize during the request
    (sequelize as any).options = (sequelize as any).options || {};
  ...
  it("posts with authors with medias does not cause N+1 queries", async () => {
    const queries: string[] = [];
    const origLogging = (sequelize as any).options?.logging;
    // capture SQL statements executed by Sequelize during the request
    (sequelize as any).options = (sequelize as any).options || {};
  ...
  it("posts with authors with posts with medias does not cause N+1 queries", async () => {
    const queries: string[] = [];
    const origLogging = (sequelize as any).options?.logging;
    // capture SQL statements executed by Sequelize during the request
    (sequelize as any).options = (sequelize as any).options || {};
